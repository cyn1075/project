...
<body>
	<?php
		$bno = $_GET['idx'];
		$hit = mysqli_fetch_array(mq("select * from escape3 where idx ='".$bno."'"));
		$hit = $hit['hit'] + 1;
		$fet = mq("update escape3 set hit = '".$hit."' where idx = '".$bno."'");
		$sql = mq("select * from escape3 where idx='".$bno."'");
...
?>
        <ul id ="ul_list">
			...
			<li><a href="escape3.php">[목록으로]</a></li>
			<li><a href="modify3.php?idx=<?php echo $board['idx']; ?>">[수정]</a></li>
